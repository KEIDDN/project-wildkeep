...
export const CROPS: CropDef[] = [
  ...
  { id: "strawberry", seed: "strawberry_seed", item: "strawberry", hours: 30, yield: [2, 3], regrow: 14, seedPrice: 16, color: 0xe03a3a, shape: "bush" },
  { id: "tomato", seed: "tomato_seed", item: "tomato", hours: 36, yield: [2, 3], regrow: 16, seedPrice: 14, color: 0xe8483a, shape: "stake" },
  { id: "corn", seed: "corn_seed", item: "corn", hours: 44, yield: [2, 3], seedPrice: 18, color: 0xf0d040, shape: "stalk" },
  { id: "pumpkin", seed: "pumpkin_seed", item: "pumpkin", hours: 60, yield: [1, 1], seedPrice: 28, color: 0xf08020, shape: "vine" },
  ...
  { id: "cabbage", seed: "cabbage_seed", item: "cabbage", hours: 34, yield: [1, 1], seedPrice: 11, color: 0x8ac86a, shape: "head" },
  // …bushes that keep giving…
  { id: "firepepper", seed: "firepepper_seed", item: "firepepper", hours: 28, yield: [2, 4], regrow: 12, seedPrice: 15, color: 0xe0402a, shape: "bush" },
  { id: "duskberry", seed: "duskberry_seed", item: "duskberry", hours: 40, yield: [3, 5], regrow: 16, seedPrice: 20, color: 0x4a6ad8, shape: "bush" },
  { id: "grapes", seed: "grape_seed", item: "grapes", hours: 48, yield: [2, 3], regrow: 18, seedPrice: 24, color: 0x8a4ab0, shape: "stake" },
  // …an apothecary's staple (brews into salves and elixirs)…
  { id: "healroot", seed: "healroot_seed", item: "healroot", hours: 30, yield: [1, 2], seedPrice: 14, color: 0xc89a6a, shape: "herb" },
  // …and something the market shouldn't really be selling.
  { id: "moonroot", seed: "moonroot_seed", item: "moonroot", hours: 80, yield: [1, 1], seedPrice: 60, color: 0x5ae0d0, shape: "root", glow: true, rare: true },
];
